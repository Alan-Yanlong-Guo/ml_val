...
def run_load_xy(years, dy=1, dq=0, save_dir='xy_data', aq='a'):
...
for tr_start in range(start_training_year, end_training_year, 1):
    ...
    oosr2, max1, max2, max3, max4, max5, y_trues, y_preds = train_test_process(data_start=start_training_year, tr_start=tr_start, tr_duration=20, ts_duration=1, dy=1, dq=0)
    oosr2_cum = {}
