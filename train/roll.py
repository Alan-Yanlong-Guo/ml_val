...
for tr_start in range(start_training_year, end_training_year, 1):
    ...
    oosr2df.to_csv(os.path.join('~/ml_val/train/result', '_'.join(["oosr2", 'q', str(0), str(1), str(start_training_year), str(end_training_year)]) + '.csv'))
    oosr2singledf.to_csv(os.path.join('~/ml_val/train/result', '_'.join(["oosr2single", 'q', str(0), str(1), str(start_training_year), str(end_training_year)]) + '.csv'))
    max1df.to_csv(os.path.join('~/ml_val/train/result', '_'.join(["max1", 'q', str(0), str(1), str(start_training_year), str(end_training_year)]) + '.csv'))
    max2df.to_csv(os.path.join('~/ml_val/train/result', '_'.join(["max2", 'q', str(0), str(1), str(start_training_year), str(end_training_year)]) + '.csv'))
    max3df.to_csv(os.path.join('~/ml_val/train/result', '_'.join(["max3", 'q', str(0), str(1), str(start_training_year), str(end_training_year)]) + '.csv'))
    max4df.to_csv(os.path.join('~/ml_val/train/result', '_'.join(["max4", 'q', str(0), str(1), str(start_training_year), str(end_training_year)]) + '.csv'))
    max5df.to_csv(os.path.join('~/ml_val/train/result', '_'.join(["max5", 'q', str(0), str(1), str(start_training_year), str(end_training_year)]) + '.csv'))